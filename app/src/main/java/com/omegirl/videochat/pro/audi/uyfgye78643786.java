...
public class uyfgye78643786 extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randomArray = new Uri[]{
                Uri.parse(new dddd01d540d5d40(this).getKeyHotVideo1()),
                Uri.parse(new dddd01d540d5d40(this).getKeyHotVideo2()),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_31.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_25.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_92.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_43.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_44.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_48.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_49.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_51.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_52.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_50.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_41.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_42.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_43.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_44.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_45.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_46.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_47.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_48.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_49.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_50.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_51.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_52.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_53.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_54.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_55.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_26.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_27.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_28.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_29.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_30.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_31.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_32.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_33.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_34.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_35.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_36.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_37.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_40.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_39.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_40.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_15.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_16.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_19.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_6.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_7.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_8.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_9.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_10.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_11.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_12.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_16.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_17.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_18.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_19.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_56.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_57.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_58.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_59.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_60.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_61.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_62.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_63.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_64.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_65.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_66.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_67.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_68.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_69.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_70.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_71.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_72.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_73.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_74.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_75.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_76.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_77.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_78.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_79.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_80.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_81.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_82.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_83.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_84.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_85.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_87.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_88.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_89.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_90.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_91.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_92.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_93.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_94.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_95.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_96.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_97.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_98.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_99.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_100.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_101.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_102.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_103.mp4"),
                Uri.parse(eoryeui012012012.baseURL(uyfgye78643786.this, defVal) + "video_104.mp4")
        ...
        actionBlock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(uyfgye78643786.this);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(uyfgye78643786.this, "User blocked successful!", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                        onBackPressed();
                    }
                });
        ...
        iv_swich_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(uyfgye78643786.this, "Please don't click many times!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void actionReport(Dialog dialog) {
        Toast.makeText(uyfgye78643786.this, "Report submitted.", Toast.LENGTH_SHORT).show();
        dialog.dismiss();
        onBackPressed();
    }
