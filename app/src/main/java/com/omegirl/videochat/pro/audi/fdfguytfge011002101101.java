...
public class fdfguytfge011002101101 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_call_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (new dddd01d540d5d40(fdfguytfge011002101101.this).getKeyInAppMode().equals("1")) {
                    if (new uhsdfiffhud02101201010().getVipType().equals("in_app_gold") || new uhsdfiffhud02101201010().getVipType().equals("in_app_silver") || new uhsdfiffhud02101201010().getVipType().equals("in_app_bronze")) {
                        ...
                        if (new uhsdfiffhud02101201010().isFreeIncomingActive()) {
                            new uhsdfiffhud02101201010().setFreeIncoming(false);
                            connectVideoCall();
                        } else {
                            //todo: pay init
                            if (new dddd01d540d5d40(fdfguytfge011002101101.this).getPayMode().equalsIgnoreCase("1")) {
                                //upi normal
                                startActivity(new Intent(fdfguytfge011002101101.this, mnnmnvmcnvm120210.class));
                            } else if (new dddd01d540d5d40(fdfguytfge011002101101.this).getPayMode().equalsIgnoreCase("2")) {
                                //upi direct
                                startActivity(new Intent(fdfguytfge011002101101.this, nxbmcxbcjxc102102120.class));
                            } else if (new dddd01d540d5d40(fdfguytfge011002101101.this).getPayMode().equalsIgnoreCase("3")) {
                                //upi razorpay
                                Toast.makeText(fdfguytfge011002101101.this, "razorpay", Toast.LENGTH_SHORT).show();
                            } else {
                                startActivity(new Intent(fdfguytfge011002101101.this, mnnmnvmcnvm120210.class));
                            }
                            finish();
    ...
    private void connectVideoCall() {
        ...
        startActivity(new Intent(fdfguytfge011002101101.this, uyfgye78643786.class));
        finish();
    }
